...
const ROLE_PAGES: Record<BaseRole, Record<PageKey, ModuleKey[]>> = {
  admin: {
    ...
    coordinacion: ["coordinacion_interna", "partidos", "solicitudes", "compras_facturas", "inventario", "viajes"],
  ...
  tecnico: {
    ...
    coordinacion: ["coordinacion_interna", "partidos", "solicitudes", "viajes"],
    admin: [],
  },
  medico: {
    home: [],
  ...
  staff: {
    ...
    coordinacion: ["coordinacion_interna", "partidos", "solicitudes", "inventario", "viajes"],
    admin: [],
  },
  jugador: {
    home: [],
